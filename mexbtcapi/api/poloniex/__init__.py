from mexbtcapi.api.poloniex.rest import PoloniexMarket, get_all_currency_pairs, client as rest_client
...
class PoloniexExchange(Exchange):
    def __init__(self):
        Exchange.__init__(self, 'Poloniex', _get_poloniex_markets())

def _refresh_currency_pairs():
...
def _get_poloniex_markets():
    return MarketList(PoloniexMarket(*cp) for cp in CURRENCY_PAIRS)
